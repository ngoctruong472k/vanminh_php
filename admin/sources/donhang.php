...
function get_item(){
	...
	if(!$id)
		transfer(_khongnhanduocdulieu, "index.php?com=order&act=man");
	
	$sql = "select * from #_donhang where id='".$id."'";
	$d->query($sql);
	if($d->num_rows()==0) transfer(_dulieukhongcothuc, "index.php?com=order&act=man");
	$item = $d->fetch_array();	
}
...
function save_item(){
	...
	if(empty($_POST)) transfer(_khongnhanduocdulieu, "index.php?com=order&act=man");
	...
	if($id){
		...
		/*--- end so luong san pham---*/
			...
			transfer(_capnhatdulieubiloi, "index.php?com=order&act=man");
	}else{
		...
		if($d->insert($data))
			...
			transfer(_luudulieubiloi, "index.php?com=order&act=man");
	}
}
...
function delete_item(){
	...
	if(isset($_GET['id']))
	{
		...
		if($d->query($sql))
			...
			transfer(_xoadulieubiloi, "index.php?com=order&act=man");
	}
	...
	else transfer(_khongnhanduocdulieu, "index.php?com=order&act=man");
}
?>