...
function save_gioithieu(){
	...
	if(empty($_POST)) transfer(_khongnhanduocdulieu, "index.php?com=footer&act=capnhat");
	...
	$d->setTable('footer');
	if($d->update($data))
		transfer(_dulieuduoccapnhat, "index.php?com=footer&act=capnhat");
	else
		transfer(_capnhatdulieubiloi, "index.php?com=footer&act=capnhat");
}
