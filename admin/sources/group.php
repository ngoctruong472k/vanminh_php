...
function get_item() {
    ...
    if (!$id)
        transfer(_khongnhanduocdulieu, "index.php?com=group&type=".$type."&act=man");

    $sql = "select * from #_group where id='" . $id . "'";
    $d->query($sql);
    if ($d->num_rows() == 0)
        transfer(_dulieukhongcothuc, "index.php?com=group&type=".$type."&act=man");
    $item = $d->fetch_array();
}
...
function save_item() {
    ...
    if ($id) {
        ...
        if ($d->update($data))
            ...
            transfer(_capnhatdulieubiloi, "index.php?com=group&type=".$type."&act=man");
    }else {
        ...
        if ($d->insert($data))
            ...
            transfer(_luudulieubiloi, "index.php?com=group&type=".$type."&act=man");
    }
}
...
function delete_item() {
    ...
    if (isset($_GET['id'])) {
        ...
        if ($d->query($sql))
            ...
            transfer(_xoadulieubiloi, "index.php?com=group&type=".$type."&act=man");
    } else
        transfer(_khongnhanduocdulieu, "index.php?com=group&type=".$type."&act=man");
}
