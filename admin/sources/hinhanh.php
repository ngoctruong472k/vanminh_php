...
function get_photo(){
	...
	if(!$id)
	transfer(_khongnhanduocdulieu, "index.php?com=hinhanh&act=man_photo&id_hinhanh=".$_REQUEST['id_hinhanh']."&type=".$_REQUEST['type']."");
	$d->setTable('hinhanh');
	$d->setWhere('id', $id);
	$d->select();
	if($d->num_rows()==0) transfer(_dulieukhongcothuc, "index.php?com=hinhanh&act=man_photo&id_hinhanh=".$_REQUEST['id_hinhanh']."&type=".$_REQUEST['type']."");
	$item = $d->fetch_array();	
}
...
function save_photo(){
	...
	if(empty($_POST)) transfer(_khongnhanduocdulieu, "index.php?com=hinhanh&act=man_photo&id_hinhanh=".$_REQUEST['id_hinhanh']."&type=".$_REQUEST['type']."");
	...
	if($id){
			...
			$d->setTable('hinhanh');
			$d->setWhere('id', $id);
			if(!$d->update($data)) transfer(_capnhatdulieubiloi, "index.php?com=hinhanh&act=man_photo&id_hinhanh=".$_REQUEST['id_hinhanh']."&type=".$_REQUEST['type']."");
		...
		for($i=0; $i<3; $i++){
				...
				if($data['photo'] = upload_image("file".$i, _format_duoihinh, _upload_hinhthem,$file_name))
					{		
						...
						$d->setTable('hinhanh');
						if(!$d->insert($data)) transfer(_luudulieubiloi, "index.php?com=hinhanh&act=man_photo&id_hinhanh=".$_REQUEST['id_hinhanh']."&type=".$_REQUEST['type']."");
					}
			}
			redirect("index.php?com=hinhanh&act=man_photo&id_hinhanh=".$_REQUEST['id_hinhanh']."&type=".$_REQUEST['type']."");
	}
...
function savestt_photo(){
	global $d;
	if(empty($_POST)) transfer(_khongnhanduocdulieu, $duongdan);
	...
	for($i=0; $i<10; $i++)
	{
		...
		if($id!='')
		{
			...
			$d->setTable('hinhanh');
			$d->setWhere('id', $id);
			if(!$d->update($data)) transfer(_capnhatdulieubiloi, $duongdan);	
		}
	}
...
function delete_photo(){
	...
	if(isset($_GET['id'])){
		...
		if($d->delete())
			...
			transfer(_xoadulieubiloi, "index.php?com=hinhanh&act=man_photo&id_hinhanh=".$_REQUEST['id_hinhanh']."&type=".$_REQUEST['type']."");
		...
		} redirect("index.php?com=hinhanh&act=man_photo&id_hinhanh=".$_REQUEST['id_hinhanh']."&type=".$_REQUEST['type']."");} else transfer(_khongnhanduocdulieu, "index.php?com=hinhanh&act=man_photo&id_hinhanh=".$_REQUEST['id_hinhanh']."&type=".$_REQUEST['type']."");
}
