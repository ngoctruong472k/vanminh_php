...
function get_item(){
	...
	if(!$id)
		transfer(_khongnhanduocdulieu, "index.php?com=hinhthucgiaohang&act=man");
	
	$sql = "select * from #_hinhthucgiaohang where id='".$id."'";
	$d->query($sql);
	if($d->num_rows()==0) transfer(_dulieukhongcothuc, "index.php?com=hinhthucgiaohang&act=man");
	$item = $d->fetch_array();
}
//===========================================================
function save_item(){
	...
	if(empty($_POST)) transfer(_khongnhanduocdulieu, "index.php?com=hinhthucgiaohang&act=man");
	...
	if($id){
		...
		if($d->update($data))
			...
			transfer(_capnhatdulieubiloi, "index.php?com=hinhthucgiaohang&act=man");
	}else{
		...
		if($d->insert($data))
			...
			transfer(_luudulieubiloi, "index.php?com=hinhthucgiaohang&act=man");
	}
}
//===========================================================
function delete_item(){
	...
	if(isset($_GET['id'])){
		...
		if($d->query($sql))
			...
			transfer(_xoadulieubiloi, "index.php?com=hinhthucgiaohang&act=man");
		...
		} redirect("index.php?com=hinhthucgiaohang&act=man");} else transfer(_khongnhanduocdulieu, "index.php?com=hinhthucgiaohang&act=man");
}
