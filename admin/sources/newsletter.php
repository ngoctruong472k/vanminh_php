...
function send(){
	...
	if(isset($_POST['listid'])){
		...
		if($mail->Send())
			transfer("Thông tin đã được gửi đi.", "index.php?com=newsletter&act=man".$urlcu);
		else
			transfer("Hệ thống bị lỗi, xin thử lại sau.", "index.php?com=newsletter&act=man".$urlcu);
