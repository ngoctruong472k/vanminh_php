...
function get_item(){
	...
	if(!$id)
		transfer(_khongnhanduocdulieu, $duongdan);
...
function save_item(){
	...
	if($id){
		...
		if($d->update($data))			
			...
			transfer(_capnhatdulieubiloi, $duongdan);
	}else{
		...
		if($d->insert($data))
			...
			transfer(_luudulieubiloi, $duongdan);
	}
}
//===========================================================
...
function delete_item(){
	...
	if(isset($_GET['id'])){
		...
		if($d->query($sql))
			...
			transfer(_xoadulieubiloi, "index.php?com=tuyendung&act=man");
		...
		} redirect("index.php?com=tuyendung&act=man");} else transfer(_khongnhanduocdulieu, "index.php?com=tuyendung&act=man");
}
...
function delete_cat(){
	...
	if(isset($_GET['id']))
	{
		...
		if($d->query($sql))
			...
			transfer(_xoadulieubiloi, $duongdan);
	}
	elseif (isset($_GET['listid'])==true)
	{
		$listid = explode(",",$_GET['listid']); 
		...
		else transfer(_khongnhanduocdulieu, $duongdan);
}
?>
