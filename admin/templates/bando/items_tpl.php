...
<div class="control_frm" style="margin-top:25px;">
    <div class="bc">
        <ul id="breadcrumbs" class="breadcrumbs">
        	<li><a href="index.php?com=bando&act=man"><span><?=_bando?></span></a></li>
        	<?php if($_REQUEST['key']!=''){ ?>
	...
	<tbody>
     <?php for($i=0, $count=count($items); $i<$count; $i++){?>
        ...
        <td class="actBtns" class="hienmb">
           ...
           <a href="index.php?com=bando&act=delete&id=<?=$items[$i]['id']?><?php if($_REQUEST['p']!='') echo'&p='.$_REQUEST['p'];?>" onClick="if(!confirm('Xác nhận xóa <?=$items[$i]['ten']?>')) return false;" title="" class="smallButton tipS" original-title="<?=_xoa?>"><img src="./images/icons/dark/close.png" alt=""></a> 
        </td>
      </tr>
           <?php } ?> 
    </tbody>
