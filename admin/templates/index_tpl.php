...
$(function () {
    $('#container').highcharts({
        ...
        title: {
            text: '<?=_thongkethang?>: <?php echo $month ?> - <?php echo $year ?> '
        },
        subtitle: {
        ...
        tooltip: {
            pointFormat: '<?=_tong?> : <b>{point.y:.1f} <?=_luottruycap?></b>'
        },
        series: [{
            name: 'Population',
            data: [
...
<div class="widget">
   <div class="title"><h6><?=_chaomung?> <a href="http://www.nina.vn" target="_blank"><span style="color:#f00;"><?=_degisnby?></span></a></h6><div class="clear"></div></div>
   <p><?=_neubanthac?> <strong><a href="mailto:nina@nina.vn">nina@nina.vn</a></strong></p>

   <div class="clear"></div>

   <div class="formRow">
        <label><?=_thongketheothang?></label>
        <div class="formRight">
                <input type="text" id="datepicker" name="datepicker" placeholder="yyyy-mm-dd">
                <input type="submit" class="blueB xemthongke" onclick="TreeFilterChanged2(); return false;" value="<?=_xemthongke?>" />
        </div>
        <div class="clear"></div>
   </div>
