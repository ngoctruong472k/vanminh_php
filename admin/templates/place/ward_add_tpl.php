<script>
    ...
    {  
        ...
        window.location ="index.php?com=place&act=<?php if($_REQUEST['act']=='edit_ward') echo 'edit_ward'; else echo 'add_ward';?><?php if($_REQUEST['id']!='') echo"&id=".$_REQUEST['id']; ?>&id_city="+a.value;   
        return true;
    }
    ...
    {   
        ...
        window.location ="index.php?com=place&act=<?php if($_REQUEST['act']=='edit_ward') echo 'edit_ward'; else echo 'add_ward';?><?php if($_REQUEST['id']!='') echo"&id=".$_REQUEST['id']; ?>&id_city="+a.value+"&id_dist="+b.value;   
        return true;
    }
    ...
    {   
        ...
        window.location ="index.php?com=place&act=<?php if($_REQUEST['act']=='edit_ward') echo 'edit_ward'; else echo 'add_ward';?><?php if($_REQUEST['id']!='') echo"&id=".$_REQUEST['id']; ?>&id_city="+a.value+"&id_dist="+b.value+"&id_ward="+f.value;   
        return true;
    }
</script>
<?php
