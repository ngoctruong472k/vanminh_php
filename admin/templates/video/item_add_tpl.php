...
<form name="supplier" id="validate" class="form" action="index.php?com=video&act=save<?php if($_REQUEST['curPage']!='') echo'&curPage='.$_REQUEST['curPage'];?>" method="post" enctype="multipart/form-data">
     ...
     <div class="widget">
       ...
       <div id="content_lang_<?=$key?>" class="tab_content">        
            ...
            <div class="formRight">
                <input type="text" name="ten<?=$key?>" title="Nhập tên Video" id="ten<?=$key?>" class="tipS ten_vi" value="<?=@$item['ten'.$key]?>" />
            </div>
            <div class="clear"></div>
        </div>  
     ...
     <div id="info" class="tab_content">
        ...
        <div class="formRow none">
            <label>Alias</label>
            <div class="formRight">
                <input type="text" value="<?=@$item['tenkhongdau']?>" name="tenkhongdau" title="Nhập tên không dấu" class="tipS" id="tenkhongdau" />
            </div>
            <div class="clear"></div>
        </div>
        <div class="formRow">
            <label>Link:</label>
            <div class="formRight">
                <input type="text" name="link" value="<?=@$item['link']?>"  title="Nhập link Youtube" class="tipS" />
            </div>
            <div class="clear"></div>
        ...
        <div class="formRow">
            <label><?=_thutu?>: </label>
            <div class="formRight">
                <input type="text" class="tipS" value="<?=isset($item['stt'])?$item['stt']:SoThuTu_ASC('video','')?>" name="stt" style="width:20px; text-align:center;" onkeypress="return OnlyNumber(event)" original-title="Số thứ tự của Video, chỉ nhập số">
            </div>
            <div class="clear"></div>
        </div>
